...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    set_flash($result >= 0 ? 'success' : 'error', $result >= 0 ? 'Berhasil' : 'Gagal', $result >= 0 ? 'Dokumen berhasil diperbarui dan kembali menunggu persetujuan.' : 'Dokumen belum bisa diperbarui.');
    redirect_to('views/documents/document_management.php');
}
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="" method="post" enctype="multipart/form-data" class="js-action-loading">
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select id="editDocumentCategory" name="id_category" class="form-control" required>
                          ...
                          <option value="<?= (int) $category['id_category']; ?>" <?= (int) $category['id_category'] === (int) $document['id_category'] ? 'selected' : ''; ?>>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        <label for="editDocumentDate">Tanggal Upload</label>
                        <input type="date" class="form-control" id="editDocumentDate" name="tanggal_upload" value="<?= h($document['tanggal_upload']); ?>" required />
                      </div>
                    </div>
